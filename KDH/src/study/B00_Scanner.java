...
public class B00_Scanner {
	...
	/*
	 	...
	 	-새 스케너를 생성할 때 어느곳으로부터 입력을 받을지 설정할 수 있다
	 	...
	 	# 스캐너 클래스의 대표적인 기능들
	 		...
	 		(1) next타입() 매서드 - nextInt(), nextDouble(),nextFloat().......
	...
	public static void main(String[] args) {
		...
		// nextInt()를 쓰고난 후 남아있는 \n의 문제가 된다면
		// nextLine()을 사용해 \n을 비워버릴수 있다	
		
//		String trash = sc.nextLine();
//		System.out.println("nextInt() 쓰고난 후 남은 입력값: " + trash);
