...
public class A05_TypeCasting {
	...
	/*
	 	...
	 	byte < short, char < int < long < float(4) < double
	...
	public static void main(String[] args) {
		...
		//큰 타입 값을 작은 타입에 넣을 때는 강제 형변환하여 대입이 가능하지만
		//값이 손상될 수도 있다
		int num = 200;
		byte bnum = (byte)num;
		...
		// 같은 2byte지만 서로 강제 타입케스팅이 필요한 관계
		short snum = -30000;
		char ch1 = '박';
		...
		// 소수점 아래를 삭제하고 싶은 경우
		System.out.println((int)123.655);
		
		// 소수점 아래를 반올림 하고 싶은 경우
		System.out.println(Math.round(123.555));
		
		// 원하는 소수점에서 반올림하고 싶은 경우
		// (1) 반올림 하고 싶은 숫자를 소수점 첫째 자리로 만들어 준다
