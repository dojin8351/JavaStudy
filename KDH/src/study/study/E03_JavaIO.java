...
public class E03_JavaIO {
	/*
	 	# IO (input/OutPut)
	 	- 데이터의 입력과 출력을 의미한다
	 	- 자바는 스트림(통로)라는 개념을 통해 프로그램의 입/출력을 다룬다
	...
	public static void main(String[] args) {
		try {
			...
			// (저장매체(CD, USB, SSD 등)으로 데이터를 내보낼 수 있는 통로를 생성한다)
			FileOutputStream out = new FileOutputStream("myfiles/text.txt");
			try {
				// OutputStream으로는 byte값을 벗어나는 값은 다룰 수 없다
				out.write('한');
				out.write(66);
				out.write(67);
				out.write('\n');
			...
			e.printStackTrace(); //파일 통로 생성중 발생한 예외
		}
