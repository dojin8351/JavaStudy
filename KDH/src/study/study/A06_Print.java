...
public class A06_Print {
	...
	/*
		...
		3. printf()	
			...
			*printf()에 사용할 수 있는 서식 문자의 종류
			...
			%x : 해당 자리에 전달한 정수값을 16진수로 출력, 알바벳을 소문자로 출력(hexa)
	...
	public static void main(String[] args) {
		...
		System.out.printf("%d년도 %d월 %d일 %d:%d:%d\n", 
				year, month, date, hour, minute, second);
		
		// 단독사용시
		System.out.println(); //줄바꿔주는 역할을 할수있다
		//System.out.print(); 데이터가 없으면 에러가 발생한다.
		
		System.out.printf("15를 10진수로 표현하면? %d\n", 15);
		System.out.printf("15를 8진수로 표현하면? %o\n", 15);
		System.out.printf("15를 16진수로 소문자 표현하면? %x\n", 15);
		System.out.printf("15를 16진수로 대문자 표현하면? %X\n", 15);
		...
		System.out.printf("%04d\t%04d\t%04d\t%04d\t%04d\t\n" , 3, 4, 5, 6, 7);
		...
		System.out.printf("오늘의 최고기온: %12s℃\n", "alice");
