...
// 실수로 창을 닫았을 때 Window -> Show View 에서 다시 열 수 있다
// Ctrl + [+,-] : 글자 크기 조절
// Ctrl + M : 현재 창 최대화
// Ctrl + W : 현재 창 닫기
...
// Ctrl + F11 : 빌드(컴파일 + 실행)
// Ctrl + F2 : 에러(빨강) 또는 경고(노란줄)가 있을 때 원인 및 해결책 띄우기
	...
	// 주석 : 프로그램에 영향을 미치지 않는 텍스트	
		...
		public static void main(String[] args) {
			...
			/*
			 	...
			 	- ()안에 전달할 데이터를 이 프로그램을 실행한 운영체제의
			 	  콘솔 화면에 출력해주는 함수
			 	  
			 	# 콘솔
			 	- 각 운영체제에 기본으로 탑재되어 있는 슬자만 나오는 화면
			...
			/*
			 	...
			 	1. "" 사이에 적는것 : 문자열(String), 문자를 여러개 적을 수 있다
			 	2. '' 사이에 적는것 : 문자(Character), 문자를 하나만 적을 수 있다
			 	3. 그냥 정수를 적는 것 : 정수(Integer), 계산 가능
			 	4. 그냥 실수를 적는 것 : 실수(Float, Double), 계산 가능
			 	5. 그냥 true 또는 false 를 적는 것 : 참/거짓형 데이터
			...
			System.out.println((int)'漢'); // '漢'는 28450번쨰 문자입니다.
			System.out.println((int)'A'); // 'A' 는 65번째 문자입니다.
			...
			System.out.println(9999 + 123); //10122
			
			// 4. 실수 예시
			System.out.println(3.14 * 9); //28.26
			System.out.println(123.123 + 345.345); //468.468
			...
			System.out.println(10 + 3 * 8); //34 사칙연산 곱하기먼저
			...
			//6. 아주 큰 숫자
			System.out.println(1234567891); // 숫자를 적을 때는 대략 22억까지 사용 가능
